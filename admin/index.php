...
if (isset($_POST['admin_login'])) {
    ...
    // SQL to log in user
    $stmt = $conn->prepare("SELECT ad_email ,ad_pwd , ad_id FROM his_admin WHERE ad_email=? AND ad_pwd=? ");
...
<head>
        <meta charset="utf-8" />
        <title>City EyeHospital - A Super Responsive Information System</title>
