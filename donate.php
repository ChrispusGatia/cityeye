    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="section-title text-center">
            ...
            <p>Explore City Eye Hospital's FAQs for answers to common queries about our practice, facilities, and medical services. If your question isn't covered, feel free to contact us for personalized assistance in maintaining healthy eye care and vision.</p> 
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <iframe width="100%" height="315" src="https://www.youtube.com/embed/gDw6yv4m_Rc" frameborder="0" allowfullscreen></iframe>
        </div>
