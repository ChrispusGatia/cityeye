...
<html lang="en">
  ...
  ================================================== -->
    <meta charset="utf-8" />
    <title>CityEye - Outpatient Clinic</title>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="service-block mb-5 feature-item">
              ...
              <div class="content">
                <h4 class="mt-4 mb-2 title-color">Hypertensive Clinic</h4>
                <p class="mb-4">Specialized care for individuals with high blood pressure, emphasizing lifestyle modifications and medication management.</p>
				<a href="service.php" class="btn btn-main btn-round-full">Read More<i class="icofont-simple-right ml-3"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="service-block mb-5 feature-item">
              ...
              <div class="content">
                <h4 class="mt-4 mb-2 title-color">Other Medical Conditions</h4>
                <p class="mb-4">Explore our comprehensive outpatient services covering various medical conditions with personalized care plans.</p>
				<a href="service.php" class="btn btn-main btn-round-full">Read More<i class="icofont-simple-right ml-3"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="service-block mb-5 feature-item">
              ...
              <div class="content">
                ...
                <p class="mb-4">State-of-the-art laboratory facilities for accurate and timely diagnostic tests, ensuring the best possible care for our patients.</p>
				<a href="service.php" class="btn btn-main btn-round-full">Read More<i class="icofont-simple-right ml-3"></i></a>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="cta-content">
              ...
              <h2 class="mb-5 text-lg">Contact us today for personalized <span class="title-color">medical care.</span></h2>
