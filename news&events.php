...
<head>
    <!-- Basic Page Needs ================================================== -->
    <meta charset="utf-8" />
    <title>City Eye Hospital - News and Events</title>
    ...
    <meta
        name="generator"
        content="City Eye Hospital News and Events Page v1.0"
    />
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block text-center">
                        <span class="text-white">News and Events</span>
                        <h1 class="text-capitalize mb-5 text-lg">Our Latest News and Events</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 mb-5">
                            <div class="blog-item">
                                <div class="blog-thumb">
                                    <img src="images/news/general.jpg" alt="" class="img-fluid ">
                                </div>
                                <div class="blog-item-content">
                                    ...
                                    <h2 class="mt-3 mb-3"><a href="news-single.html">Exciting News Title Here</a></h2>
                                    ...
                                    <a href="news-single.html" target="_blank" class="btn btn-main btn-icon btn-round-full">Read More <i class="icofont-simple-right ml-2  "></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 mb-5">
                            <div class="blog-item">
                                ...
                                <div class="blog-item-content">
                                    ...
                                    <h2 class="mt-3 mb-3"><a href="news-single.html">Another Exciting News Title</a></h2>
                                    <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis aliquid architecto facere commodi cupiditate omnis voluptatibus inventore atque velit cum rem id assumenda quam recusandae ipsam ea porro, dicta ad.</p>
                                    <a href="news-single.html" target="_blank" class="btn btn-main btn-icon btn-round-full">Read More <i class="icofont-simple-right ml-2  "></i></a>
                                </div>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="sidebar-wrap pl-lg-4 mt-5 mt-lg-0">
                        ...
                        <!-- Example Sidebar Widget (Latest Posts) -->
                        ...
                        <!-- Example Sidebar Widget (Categories) -->
