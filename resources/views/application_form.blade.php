                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="submit_application" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="position">Position Applying For<sup
                                                style="color: red;">*</sup></label>
                                        <select name="position" id="position" class="form-control" required>
                                            <option value="senior_web_developer">Senior Web Developer</option>
                                            <option value="ophthalmology_consultant_retina">Ophthalmology Consultant
                                                (Retina)</option>
                                            <option value="business_development_manager">Business Development Manager
                                            </option>
                                            <option value="ophthalmic_assistant_trainee_2024">Ophthalmic Assistant
                                                Trainee-2024</option>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="highest_qualification">Highest academic qualifications<sup
                                                    style="color: red;">*</sup></label>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="major">Major field of academic Study<sup
                                                    style="color: red;">*</sup></label>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="graduation_date">Graduation Date<sup
                                                    style="color: red;">*</sup></label>
                                            <input type="date" name="graduation_date" id="graduation_date"
                                                class="form-control" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="professional_qualification">Professional
                                                Qualification/Certification<sup style="color: red;">*</sup></label>
                                            <input type="text" name="professional_qualification"
                                                id="professional_qualification" class="form-control" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" name="currently_employed" id="yes"
                                                class="form-check-input" value="Yes" required>
                                            <label for="yes" class="form-check-label">Yes</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input type="radio" name="currently_employed" id="no"
                                    ...
                                    <div class="form-group">
                                        <label for="current_employer">Name of Current Employer<sup
                                                style="color: red;">*</sup></label>
                                    ...
                                    <div class="form-group">
                                        <label for="experience_years">Years of Experience<sup
                                                style="color: red;">*</sup></label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="current_gross_pay" id="current_gross_pay"
                                            class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label for="expected_gross_pay">Expected Gross Monthly Pay (KES)</label>
                                        <input type="number" name="expected_gross_pay" id="expected_gross_pay"
                                            class="form-control" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="resume" id="resume"
                                            class="form-control-file" accept=".pdf,.doc,.docx" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="academic_certificate">Attach Your Academic Certificates</label>
                                        <input type="file" name="academic_certificate" id="academic_certificate"
                                            class="form-control-file" accept=".pdf,.doc,.docx" required>
                                    </div>
