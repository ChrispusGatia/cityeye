    ...
    <table cellpadding="0" cellspacing="0" width="100%" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1); overflow: hidden;">
        ...
        <tr>
            <td style="padding: 20px;">
                <p style="font-size: 18px; margin-bottom: 8px;"><strong>Patient Name:</strong> {{ $dataReceived['name'] }}</p>
            </td>
        </tr>
        @endif
        ...
        <tr>
            <td style="padding: 20px;">
                <p style="font-size: 18px; margin-bottom: 8px;"><strong>Patient Email:</strong> {{ $dataReceived['email'] }}</p>
            </td>
        </tr>
        @endif
        ...
        <tr>
            <td style="padding: 20px;">
                <p style="font-size: 18px; margin-bottom: 8px;"><strong>Date of Appointment:</strong> {{ $dataReceived['date'] }}</p>
            </td>
        </tr>
        @endif
