<x-layout>
    ...
    ================================================== -->
        ...
        <meta name="description"
            content="Explore educational materials to enhance your knowledge about eye health at City Eye Hospital." />
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=5.0" />
        <meta name="author" content="City Eye Hospital" />
        <meta name="generator" content="City Eye Hospital Educational Page v1.0" />
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title text-center">
                            ...
                            <p>
                                Welcome to City Eye Hospital's educational hub. Discover valuable resources designed to
                                enhance your knowledge about eye health. Whether you're a patient or a healthcare
                                professional, empower yourself with essential information.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="feature-item mb-4">
                            <div class="mb-5 text-center">
                                ...
                                <p>Explore the intricacies of the eye's anatomy and learn about each part's functions
                                    for
                                    better understanding of eye health.</p>
                    ...
                    <div class="col-lg-4">
                        <div class="feature-item mb-4">
                            <div class="mb-5 text-center">
                                ...
                                <p>Discover practical tips and habits to maintain optimal eye health and prevent common
                                    eye
                                    issues. Your eyes deserve the best care!</p>
                    ...
                    <div class="col-lg-4">
                        <div class="feature-item mb-4">
                            <div class="text-center">
                                <img src="images/educational/anatomy.jpg" alt="Common Eye Diseases"
                                    class="img-fluid w-100">
                                <h4 class="mt-3">Common Eye Diseases</h4>
                                <p>Gain insights into various eye diseases, their symptoms, and available treatment
                                    options.
                                    Knowledge is the first step towards prevention and care.</p>
                                <button class="btn btn-primary btn-sm mt-3" onclick="openVideoModal('r_dXLAvoEfg')">
                                    <i class="icofont-play-circle"></i> Watch Video
                                </button>
                            </div>
