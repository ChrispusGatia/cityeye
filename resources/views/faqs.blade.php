                        ...
                        <div class="accordion" id="faqAccordion">
                            ...
                            <div class="card">
                                ...
                                <div id="collapseOne" class="collapse" aria-labelledby="headingOne"
                                    ...
                                    <div class="card-body">
                                        <p>Yes, City Eye Hospital has several branches, each strategically located for
                                            your
                                            convenience:</p>
                                        <ol>
                                            <li><strong>Main Hospital:</strong> Located at Ngong Road, opposite Police
                                                Traffic, Nairobi.</li>
                                            <li><strong>Nyeri Hospital:</strong> Situated at Asian Quarters, Mbuni Road,
                                                Nyeri.</li>
                                            <li><strong>Appointment Clinic:</strong> Found at Upper Hill Medical Centre
                                                (3rd
                                                Floor), Nairobi.</li>
                                            <li><strong>Vision Center:</strong> Located at Milele Mall, Ngong Town,
                                                Kajiado
                                                County.</li>
                                        </ol>
                                        <p>These locations ensure accessibility and comprehensive eye care services for
                                            our
                                            valued patients.</p>
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                    data-parent="#faqAccordion">
                                    <div class="card-body">
                                        With specialised ophthalmologists, optometrists, licensed opticians and highly
                                        trained staff,
                                        we provide an extensive range of medical services. Our range of specialities
                                        include:
                                        <ul>
