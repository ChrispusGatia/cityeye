<x-layout>
    ...
    <head>
        <!-- Basic Page Needs ================================================== -->
        <meta charset="utf-8" />
        <title>CityEye- Mission and Vision</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="section-title text-center">
                            ...
                            <p>
                                City Eye Hospital is committed to providing accessible, high-quality eye care in East
                                Africa.
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="mission-vision-core-values-item feature-item mb-4">
                            ...
                            <ul>
                                <li>Value for God</li>
                                <li>Value for People</li>
                                <li>Value for Excellence</li>
