                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="section-title text-center">
                            ...
                            <p>Discover your perfect eyewear at CityEye's Optical Shop,
                                ...
                                Open Monday to Friday, 8 am to 4 pm. Elevate your style and vision with our curated
                                collections of eyeglasses.
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="service-block mb-5 feature-item">
                            ...
                            <div class="content">
                                ...
                                <p class="mb-4">Explore a wide range of stylish and functional eyeglasses to enhance
                                    your
                                    vision and style.</p>
                                <a href="service" class="btn btn-main btn-round-full">View Collection<i
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="service-block mb-5 feature-item">
                            ...
                            <div class="content">
                                ...
                                <p class="mb-4">Discover a variety of high-quality lenses designed to cater to
                                    different
                                    visual needs.</p>
                                <a href="service" class="btn btn-main btn-round-full">Explore More<i
                                        class="icofont-simple-right ml-3"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="service-block mb-5 feature-item">
                            ...
                            <div class="content">
                                ...
                                <p class="mb-4">Choose from our stylish collection of eye frames that blend fashion
                                    and
                                    comfort seamlessly.</p>
                                <a href="service" class="btn btn-main btn-round-full">Explore Designs<i
                                        class="icofont-simple-right ml-3"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="service-block mb-5 feature-item">
                            ...
                            <div class="content">
                                ...
                                <p class="mb-4">Discover trendy and protective sunglasses that complement your style
                                    and
                                    shield your eyes.</p>
                                <a href="service" class="btn btn-main btn-round-full">Check Styles<i
                                        class="icofont-simple-right ml-3"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="service-block mb-5 feature-item">
                            ...
                            <div class="content">
                                ...
                                <p class="mb-4">Enhance your eyewear experience with our range of stylish and
                                    functional
                                    accessories.</p>
                                <a href="service" class="btn btn-main btn-round-full">View Accessories<i
                                        class="icofont-simple-right ml-3"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="service-block mb-5 feature-item">
                            ...
                            <div class="content">
                                ...
                                <p class="mb-4">Experience precise and efficient in-housing glazing services for your
                                    eyewear needs.</p>
                                <a href="service" class="btn btn-main btn-round-full">Learn More<i
                                        class="icofont-simple-right ml-3"></i></a>
                            </div>
                        </div>
                    </div>
